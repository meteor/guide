...
Another situation where you'll need to use `require` is in CoffeScript files. As CS doesn't support the `import` syntax yet, you should use `require` (read more about it in the [modules documentation](https://github.com/meteor/meteor/tree/release-1.3/packages/modules)):
